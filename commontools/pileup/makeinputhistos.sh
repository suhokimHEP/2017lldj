...
do
 ...
 do
  ...
  pileupCalc.py -i ./${dataset}.json --inputLumiJSON pileup_latest.txt --calcMode true --minBiasXsec ${xc} --maxPileupBin 75 --numPileupBins 75 ./PU_${dataset}_${xc}.root
  #pileupCalc.py -i ./${dataset}.json --inputLumiJSON /afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions17/13TeV/PileUp/pileup_latest.txt --calcMode true --minBiasXsec ${xc} --maxPileupBin 75 --numPileupBins 75 ./PU_${dataset}_${xc}.root
