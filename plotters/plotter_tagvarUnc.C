...
void plotter_tagvarUnc(TString region, TString varname, Bool_t dolog)
{
 ...
 for(unsigned int i=0; i<MSs.size(); ++i){
  ...
  for(unsigned int i=0; i<cts.size(); ++i){
   ...
   //TString outname = "tvuMS"+MS+"ct"+ct+"_"+lepname+"_"+region+"_"+varname;
   TString outname = "tvuMS"+MS+"ct"+ct+"_"+region+"_"+varname+extraname;
   //TString infilename = region+"_"+varname;
